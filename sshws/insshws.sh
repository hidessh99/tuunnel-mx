...
wget -O /etc/systemd/system/ws-stunnel.service https://raw.githubusercontent.com/hidessh99/tuunnel-mx/main/sshws/ws-stunnel.service && chmod +x /etc/systemd/system/ws-stunnel.service
