...
BURIQ () {
    curl -sS https://https://raw.githubusercontent.com/kmardhex/perizinan/main/main/allow > /root/tmp
...
Name=$(curl -sS https://https://raw.githubusercontent.com/kmardhex/perizinan/main/main/allow | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/kmardhex/perizinan/main/main/allow | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
Exp=$(curl -sS https://raw.githubusercontent.com/kmardhex/perizinan/main/main/allow | grep $MYIP | awk '{print $3}')
fi
clear
echo -e "\e[36m╒════════════════════════════════════════════╕\033[0m"
...
#[\033[1;36m18\033[0m]  Sal Panel Bot
"
...
curl -sS https://raw.githubusercontent.com/kmardhex/swip/main/clgshow
echo -e "
"
fi
echo -e "\e[36m╘═════════════════════════════════════════════╛\033[0m"
