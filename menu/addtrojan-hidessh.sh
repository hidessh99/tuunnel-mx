...
trojanlink="trojan://${uuid}@${domain}:${tr}?path=/hidessh-trojan-ws&security=tls&host=bug.com&type=ws&sni=google.com#${user}"


sleep 5 && systemctl restart trojan-ws && systemctl restart trojan-grpc
