...
trojanlink1="trojan://${uuid}@${domain}:${tr}?mode=gun&security=tls&type=grpc&serviceName=mdx-grpc&sni=bug.com#${user}"
trojanlink="trojan://${uuid}@${domain}:${tr}?path=%2Fmdx&security=tls&host=bug.com&type=ws&sni=bug.com#${user}"
clear
