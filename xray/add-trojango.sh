...
link="trojan-go://${uuid}@isi_bug_disini:${trgo}/?sni=${domain}&type=ws&host=${domain}&path=%2Fhidessh-trojango#$user"
link1="trojan://${uuid}@isi_bug_disini:${trgo}/?sni=${domain}&type=ws&host=${domain}&path=%2Fhidessh-trojango#$user"
clear
...
echo -e "Path       : /hidessh-trojango" | tee -a /etc/log-create-user.log
