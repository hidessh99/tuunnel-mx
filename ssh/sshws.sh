...
wget -q -O /usr/bin/proxy3.js "https://raw.githubusercontent.com/hidessh99/tuunnel-mx/main/proxy3.js"
...
wget -q -O /usr/bin/ssh-wsenabler "https://raw.githubusercontent.com/hidessh99/tuunnel-mx/main/sshws/service-wsopenssh" && chmod +x /usr/bin/ssh-wsenabler && /usr/bin/ssh-wsenabler
